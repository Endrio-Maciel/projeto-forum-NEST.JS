...
-- AddForeignKey
ALTER TABLE "answers" ADD CONSTRAINT "answers_questio_id_fkey" FOREIGN KEY ("questio_id") REFERENCES "questions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
